        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Treatements = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearOfExperiences = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineProviders", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_MedicineProviders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiseaseSymptoms_Symptomses_SymptomsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleDoctors_ScheduleDates_ScheduleDateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_MedicineProviders_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "MedicineProviders",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_Doctors_DoctorUserId",
                        column: x => x.DoctorUserId,
                        principalTable: "Doctors",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Feedbacks_Patients_PatientUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    MedicineProviderUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_MedicineProviders_MedicineProviderUserId",
                        column: x => x.MedicineProviderUserId,
                        principalTable: "MedicineProviders",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Orders_Patients_PatientUserId",
                        column: x => x.PatientUserId,
                        principalTable: "Patients",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ScheduleDoctorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientBookings_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        ...
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_PatientBookings_ScheduleDoctors_ScheduleDoctorId",
                        column: x => x.ScheduleDoctorId,
                        principalTable: "ScheduleDoctors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionsDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionsDetail_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescriptionsDetail_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeesDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Price = table.Column<double>(type: "float", nullable: false),
                    PatientBookingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeesDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeesDoctors_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_FeesDoctors_PatientBookings_PatientBookingId",
                        column: x => x.PatientBookingId,
                        principalTable: "PatientBookings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FeesDoctors_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    FeesDoctorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_FeesDoctors_FeesDoctorId",
                        column: x => x.FeesDoctorId,
                        principalTable: "FeesDoctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_Patients_PatientUserId",
                        column: x => x.PatientUserId,
                        principalTable: "Patients",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiseaseSymptoms_SymptomsId",
                table: "DiseaseSymptoms",
                column: "SymptomsId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_DoctorUserId",
                table: "Feedbacks",
                column: "DoctorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_PatientUserId",
                table: "Feedbacks",
                column: "PatientUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FeesDoctors_DoctorId",
                table: "FeesDoctors",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_FeesDoctors_PatientBookingId",
                table: "FeesDoctors",
                column: "PatientBookingId");

            migrationBuilder.CreateIndex(
                name: "IX_FeesDoctors_PatientId",
                table: "FeesDoctors",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_MedicineProviderUserId",
                table: "Orders",
                column: "MedicineProviderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientBookings_DoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientBookings_ScheduleDoctorId",
                table: "PatientBookings",
                column: "ScheduleDoctorId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Payments_FeesDoctorId",
                table: "Payments",
                column: "FeesDoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionsDetail_MedicineId",
                table: "PrescriptionsDetail",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionsDetail_PrescriptionId",
                table: "PrescriptionsDetail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDoctors_ScheduleDateId",
                table: "ScheduleDoctors",
